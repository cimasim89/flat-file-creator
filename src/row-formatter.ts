...
const prepareToConcatData = (data: FieldData) => (acc: string, field: FieldSpec) =>
  acc + fieldFormatter(field, data)

const rowFormatter = (maps: Array<FieldSpec>, data: FieldData, options: Partial<GlobalOptions>) => {
